...
def main():
    # 老人企业补贴
    dbf = read_dbf(
        filename=r"E:\企业补贴\数据\企业补贴202505\bt_ltx.dbf", # dbf
        ...
        sheets=[
            {
                ...
                "title": {
                    "cell":"A1",
                    "value":"2025年5月全民离退休人员企业补贴发放汇总表(单位)"
                },
                "arch":"B4",
                "data": data_qm,
            },
            {
                ...
                "title": {
                    "cell":"A1",
                    "value":"2025年5月全民离退休人员企业补贴发放汇总表(银行)"
                },
                "arch":"G4",
                "data": bank_data,
            }
        ],
        output=r"E:\企业补贴\银行报盘\2025年\5月\老人企业补贴汇总202505.xlsx",
    )
    ...
    # 集体工企业补贴
    dbf2 = read_dbf(
        filename=r"E:\企业补贴\数据\集体工企业补贴202505\bt_ltx.dbf", # dbf
    ...
    export_data(
        ...
        sheets=[
            ...
            },
            {
                ...
                "title": {
                    "cell":"A1",
                    "value":"2025年5月退休集体工企业补贴发放汇总表(含遗孀)"
                },
                "arch":"B4",
                "data": fqm_data,
            },
            {
                ...
                "title": {
                    "cell":"A1",
                    "value":"2025年5月退休集体工企业补贴发放汇总表(工程)"
                },
                "arch":"J4",
                "data": gc_data,
            },
            {
                ...
                "title": {
                    "cell":"A1",
                    "value":"2025年5月退休集体工企业补贴发放汇总表(银行)"
                },
                "arch":"H4",
                "data": bank_data2,
            }
        ],
        output=r"E:\企业补贴\银行报盘\2025年\5月\退休集体工企业补贴汇总202505.xlsx",
    )
