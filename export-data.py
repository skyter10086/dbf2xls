...
# Paths 文件路径"
path_a = r"E:\企业补贴\数据\企业补贴202505"
path_b = r"E:\企业补贴\数据\集体工企业补贴202505"
...
export_datagrid(
    ...
    output=r"E:\企业补贴\银行报盘\2025年\5月\工行报盘\老人企业补贴(工行报盘-跨行)_202505.xlsx",
)
...
export_datagrid(
    ...
    output=r"E:\企业补贴\银行报盘\2025年\5月\工行报盘\老人企业补贴(工行报盘-本行)_202505.xlsx",
)
...
export_datagrid(
    ...
    index=True,
    output=r"E:\企业补贴\银行报盘\2025年\5月\建行报盘\老人企业补贴(建行报盘)_202505.xlsx",
)
...
export_datagrid(
    ...
    index=True,
    output=r"E:\企业补贴\银行报盘\2025年\5月\中行报盘\老人企业补贴(中行南阳报盘)_202505.xlsx",
)
...
export_datagrid(
    ...
    output=r"E:\企业补贴\银行报盘\2025年\5月\工行报盘\集体工企业补贴(工行报盘-跨行)_202505.xlsx",
)
...
export_datagrid(
    ...
    output=r"E:\企业补贴\银行报盘\2025年\5月\工行报盘\集体工企业补贴(工行报盘-本行)_202505.xlsx",
)
...
export_datagrid(
    ...
    columns=["X_银行帐号", "姓名", "实发补贴"],
    index=True,
    output=r"E:\企业补贴\银行报盘\2025年\5月\建行报盘\集体工企业补贴(建行报盘)_202505.xlsx",
)
...
export_datagrid(
    ...
    columns=["姓名", "身份证", "发放银行", "X_银行帐号", "实发补贴"],
    index=True,
    output=r"E:\企业补贴\银行报盘\2025年\5月\中行报盘\集体工企业补贴(中行南阳报盘)_202505.xlsx",
)
...
export_datagrid(
    ...
    index=False,
    output=r"E:\企业补贴\银行报盘\2025年\5月\中行报盘\集体工企业补贴(中行油区报盘)_202505.xlsx",
)
